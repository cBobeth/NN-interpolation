...
lr_lst = [0.7, 0.4, 0.1, 0.07, 0.04, 0.01, 0.007, 0.004, 0.001]

for lr in lr_lst:
    run = Run_Model(f"run_SGD_arch4_lr-{lr}",
                    Configurable_Linear_NN, n_in, arch_4,
                    hyper_SGD_MSE(lr, 2000, 16, 0.0), data)
    run_lst.append(run)
...
run_lst_file_name = 'SGD_arch4_lr.pkl'
